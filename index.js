...
// Usz0E31KP3fyyBQ3
const uri = `mongodb+srv://mohid10587:Usz0E31KP3fyyBQ3@cluster5.4relj71.mongodb.net/?retryWrites=true&w=majority`;
// const uri = "mongodb://127.0.0.1:27017/newbookshop";
...
async function run() {
  try {
    ...
    const productsCollection = client.db("newbookshop").collection("products");
    const cartProductsCollection = client.db("newbookshop").collection("cart");
    const ordersCollection = client.db("newbookshop").collection("orders");
    const usersCollection = client.db("newbookshop").collection("users");
